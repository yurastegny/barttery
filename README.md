...
> iPhone and Apple Watch remain visible for up to 24 hours after the last successful sync. I don’t know how to make Barttery force a connection to iOS — the Mac can only wait for the iPhone to accept the connection on its own. To see when the last sync happened, expand the device row in the menu.
